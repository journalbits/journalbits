...
JournalBits::Application.routes.draw do
  ...
  get 'users/reauth/evernote' => 'evernote_accounts#reauth'
  get 'users/reauth/facebook' => 'facebook_accounts#reauth'
  get 'users/reauth/fitbit' => 'fitbit_accounts#reauth'
  get 'users/reauth/github' => 'github_accounts#reauth'
  get 'users/reauth/healthgraph' => 'health_graph_accounts#reauth'
  get 'users/reauth/instagram' => 'instagram_accounts#reauth'
  get 'users/reauth/instapaper' => 'instapaper_accounts#reauth'
  get 'users/reauth/lastfm' => 'lastfm_accounts#reauth'
  get 'users/reauth/moves' => 'moves_accounts#reauth'
  get 'users/reauth/pocket' => 'pocket_accounts#reauth'
  get 'users/reauth/twitter' => 'twitter_accounts#reauth'
  get 'users/reauth/wunderlist' => 'wunderlist_accounts#reauth'
