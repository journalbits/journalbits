...
class WunderlistWorker
  ...
  def perform date, user_id
    ...
    all_tasks = combine_tasks_created_and_completed_on date
    lists = user_lists
  ...
  def combine_tasks_created_and_completed_on date
    tasks_completed_today = user_tasks_completed_on date
    tasks_created_today = user_tasks_created_on date
